# Java code intelligence for Sourcegraph

A [Sourcegraph extension](https://docs.sourcegraph.com/extensions) that provides code intelligence (go-to-definition and find-references) for Java, using text-based heuristics.

[**🗃️ Source code**](https://github.com/sourcegraph/sourcegraph-java)

[**➕ Add to Sourcegraph**](https://sourcegraph.com/extensions/sourcegraph/java) (see [usage instructions](#usage) for self-hosted Sourcegraph instances)
...
1. Enable the `sourcegraph/java` extension:
   - On Sourcegraph.com, visit [sourcegraph.com/extensions/sourcegraph/java](https://sourcegraph.com/extensions/sourcegraph/$LANGNAME) to enable it.
   - On a self-hosted Sourcegraph instance, select **User menu > Extensions**, search for `sourcegraph/java`, and enable it.
...
1. Follow the [usage steps](#usage) above to enable this `sourcegraph/java` extension.
...
![screenshot of using java on GitHub](https://user-images.githubusercontent.com/1976/50882271-0c5f3180-1399-11e9-9697-e4e4fa4e29e9.png)
